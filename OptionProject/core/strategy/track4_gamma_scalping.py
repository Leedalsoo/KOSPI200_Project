...
# 원격 Exp_Detail_1/option_program/strategy/plugins/track4.py를 직접 검토했다. 핵심 기능은 10% 자본 배분, 변동성 기반 Basecamp, ATR 동적 Delta Hedge Deadband, Theta Decay Guard, 3단계 Profit Trailing이다. fileciteturn289file0L2-L6
### 보존 기능
