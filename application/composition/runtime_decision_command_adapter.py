...
from core.runtime.reference_execution_pipeline import DecisionCommandContext, approved_signal_to_command
...
class RuntimeDecisionCommandAdapter:
    ...
    def build_commands(self, evaluations: Iterable[RuntimeStrategyEvaluation], approved_signals: Iterable[CanonicalStrategySignal]) -> tuple[CanonicalOrderCommand, ...]:
        ...
        for signal in approved_signals:
            ...
            commands.append(approved_signal_to_command(signal, context=DecisionCommandContext(client_order_id=evaluation.runtime_context.client_order_id(track_id))))
