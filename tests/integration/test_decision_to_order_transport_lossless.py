...
from contracts.canonical_order_transport import (
...
def make_signal(signal_id="sig-1", side=Side.BUY):
    return Signal(signal_id, "Track4", AssetType.OPTION, side, 3, 1.25, OptionType.CALL, Decimal("350"), "GAMMA_REBALANCE", "KOSPI200-C-350", "20260910")
...
def test_transport_accepts_only_authoritative_identity_fields():
    request = CanonicalOrderTransportInput("ORD-1", "OPTION", "BUY", 3, Decimal("1.25"), "CALL", Decimal("350"), "KOSPI200-C-350", "20260910", "Track4", "GAMMA_REBALANCE", "AUTH-OPT-350-C-20260910")
    validate_lossless_transport(request)


def test_transport_fails_closed_when_option_identity_is_incomplete():
    request = CanonicalOrderTransportInput("ORD-1", "OPTION", "BUY", 3, Decimal("1.25"), "CALL", Decimal("350"), None, "20260910", "Track4", "GAMMA_REBALANCE", "AUTH-OPT-350-C-20260910")
