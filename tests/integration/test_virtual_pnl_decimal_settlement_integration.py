...
def test_unrealized_long_short_decimal_precision_without_rounding():
    engine=PnLEngine(); positions={"LONG":{"side":"BUY","avg_price":Decimal("101.833333333333333333"),"qty":Decimal("3")},"SHORT":{"side":"SELL","avg_price":Decimal("102.166666666666666667"),"qty":Decimal("2")}}
...
def test_realized_pnl_and_ledger_preserve_decimal_values():
    pnl=PnLEngine(); pnl.add_realized(Decimal("123.456789123456789")); ledger=LedgerEngine()
